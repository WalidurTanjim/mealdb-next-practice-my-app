                ...
                <div className="relative flex h-16 items-center justify-between">
...

                    {
                        sessionStatus === 'authenticated' ?
                            ...
                            <Link href={`/signup`}>
                                <button className='px-5 py-1.5 border border-gray-300 rounded outline-none text-white text-sm font-medium hover:bg-slate-700 active:bg-transparent'>Sign up</button>
                            </Link>
                    }
                </div>
            </div>
            ...
            <DisclosurePanel className="sm:hidden">
                <div className="space-y-1 px-2 pt-2 pb-3">
                    {navigation.map((item) => (
                        ...
                        >
                            <Link href={item.name} className="w-full">{item.name}</Link>
                        </DisclosureButton>
                    ))}
                </div>
            </DisclosurePanel>
